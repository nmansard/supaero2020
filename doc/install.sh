...
sudo apt-get update
sudo apt install robotpkg-py36-pinocchio robotpkg-py36-qt4-gepetto-viewer-corba ipython3 python3-pip freeglut3 python3-matplotlib python3-pil.imagetk jupyter python3-scipy python3-matplotlib jupyter python3-scipy python3-numpy robotpkg-example-robot-data robotpkg-osg-dae
